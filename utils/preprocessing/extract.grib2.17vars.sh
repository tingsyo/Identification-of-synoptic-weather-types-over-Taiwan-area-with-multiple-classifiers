#!/usr/bin/bash
DATASRC="/cygdrive/d/work/atmosphericscience_data/ncep-cfsr/"
...
#bash extract.grib2.sh $DATASRC 1979 2010 "TMP:800" $OUTPUT/t800/  > log.t800.log 
#bash extract.grib2.sh $DATASRC 1979 2010 "RH:800" $OUTPUT/rh800/  > log.rh800.log 
